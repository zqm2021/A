...
*/
let hjh = {
    email: $.isNode() ? process.env.hjhEmail : '',
    pwd: $.isNode() ? process.env.hjhPassword : ''
};
...
let iku = {
    email: $.isNode() ? process.env.ikuuuEmail : '',
    pwd: $.isNode() ? process.env.ikuuuPassword : ''
};
...
let jj = {
    email: $.isNode() ? process.env.luxuryEmail : '',
    pwd: $.isNode() ? process.env.luxuryPassword : ''
};
